...
float mq2Pin = 14; // MQ-2 for smoke and flammable gases
  ...
  while (gpsSerial.available() > 0) {
    if (gps.encode(gpsSerial.read())) {
      ...
      //   Serial.println("---------------------------");
        ...
        dataString += String(air_quality) + "PPM" + ",";
       ...
       delay(1000); // Wait a second before the next reading}
        ...
        updateState(bme.readAltitude(altitude));
        ...
        if (dataFile) {
          ...
          dataFile.print(",");
          dataFile.print(number_of_satellites);
          dataFile.print(",");
          dataFile.print(temperature);
          dataFile.print(",");
          dataFile.print(pressure);
          dataFile.print(",");
          dataFile.print(net_acc);
          dataFile.print(",");
          dataFile.print(gyro_spin_rate);
          dataFile.print(",");
